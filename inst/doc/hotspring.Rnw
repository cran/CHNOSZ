...
The thermodynamic data for the methionine sidechain group used in
the paper has been superseded in CHNOSZ\_0.9-9 \citep{LD12}, but
the older dataset is still available using \texttt{add.obigt()}:
